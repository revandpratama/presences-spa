    ...
    <nav class="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <Link href="/home" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">e-Presence</span>
            </Link>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul
                    ...
                    <li>
                        <Link href="/home"
                            class="block py-2 pl-3 pr-4 text-black rounded md:bg-transparent md:p-0 dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent"
                            :class="{' text-blue-700': $page.component == 'Home'}"
                    ...
                    <li>
                        <div class="flex items-center" v-if="user">
                            <div class="flex items-center ml-3">
                                <div>
                                    <button type="button"
                                        class="flex text-sm bg-gray-800 rounded-full border-2 border-green-500 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                        ...
                        <div v-else>
                            <Link href="/login" as="button" class="text-white bg-blue-500 px-3 py-1 rounded-md">
                                Login</Link>
                        </div>
                    </li>
                </ul>
